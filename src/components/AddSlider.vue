<template>
  <div class="container">
    ...
    <div class="row pt-3">
      <div class="col-8">
        <button type="submit" class="btn btn-primary btn-block" @click="editSlider()">Update</button>
      </div>
      <div class="col-4">
        <button type="button" class="btn btn-danger btn-block" @click="cancelNews()">Cancel</button>
      </div>
    </div>
  </div>
</template>
